...
if __name__ == '__main__':
    ...
    parser.add_argument('--bit_cfg', type=str, default="None") #混合精度
    ...
    parser.add_argument('--use_bias', action='store_true', help='fix weight bias and variance after quantization') #新增
    parser.add_argument('--vcorr', action='store_true', help='use variance correction') #新增
    parser.add_argument('--bcorr', action='store_true', help='use bias correction') #新增
    ...
    qnn.set_bias_state(args.use_bias, args.vcorr, args.bcorr) #新增
    print('Weight quantization accuracy: {}'.format(validate_model(test_loader, qnn)))
    qnn.set_bias_state(False, False, False) #新增
