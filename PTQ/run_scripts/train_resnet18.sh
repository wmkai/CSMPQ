...
#
## resnet-18 4.0Mb cdp
# python main_imagenet.py --data_path /home/data/imagenet --arch resnet18 --n_bits_w 2 --channel_wise --n_bits_a 8 --act_quant --test_before_calibration --bit_cfg "[4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 3, 3, 4, 2, 2, 3, 4]" --gpu '0'
# 
## resnet-18 4.5Mb cdp
# python main_imagenet.py --data_path /home/data/imagenet --arch resnet18 --n_bits_w 2 --channel_wise --n_bits_a 8 --act_quant --test_before_calibration --bit_cfg "[4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 3, 2, 3, 4]" --gpu '0'
# 
## resnet-18 5.0Mb cdp
# python main_imagenet.py --data_path /home/data/imagenet --arch resnet18 --n_bits_w 2 --channel_wise --n_bits_a 8 --act_quant --test_before_calibration --bit_cfg "[4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 3, 3, 4, 4]" --gpu '1'
#
### resnet-18 5.5Mb cdp
